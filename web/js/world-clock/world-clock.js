(function($){
    $(function(){
        function setTime($clock, hour, minute) {
            ...
            var padding = parseFloat($clock.css('padding-top'));
            var width = Math.ceil($scoreboard_container.width());
            var height = Math.ceil($scoreboard_container.height());
...
console.info([width, height]);
            ...
            $scoreboard.html("");
            $scoreboard.append("<circle class=\"border\" cx=\"" + clockCenter.x + "\" cy=\"" + clockCenter.y + "\" r=\"" + (clockCenter.x - 3) + "\"/>");
